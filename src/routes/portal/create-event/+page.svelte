<script lang="ts">
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      // Navigate to the full editor with the created event ID
      goto(`/portal/upload-event?id=${result.eventId}`);
...
<main class="bg-gray-50 py-8 px-8 overflow-y-auto">
  <div class="max-w-2xl mx-auto">
    ...
    <div class="mb-8">
      ...
      <p class="text-gray-600">Start by entering the basic information about your event. You'll be able to add photos and detailed descriptions in the next step.</p>
    </div>
      ...
      <div class="flex items-start">
        <div class="ml-3">
          ...
          <div class="mt-1 text-sm text-blue-700">
            <p>After clicking "Continue to Editor", you'll be able to:</p>
            <ul class="mt-2 list-disc list-inside space-y-1">
              <li>Write detailed descriptions using Markdown formatting</li>
              <li>Upload and paste images directly into your content</li>
              <li>Preview your event before publishing</li>
              <li>Make final adjustments and publish</li>
            </ul>
          </div>
        </div>
      </div>
